...
public class Inventory : MonoBehaviour
{
    ...
    public void CreateInventory()
    {
        ...
        // Consumable Items
        consumableItemsController.AddItem(new ConsumableItem("First-Aid Kit", 10, 1 ));

        // Non-Consumable Items
        nonConsumableItemsController.AddItem(new NonConsumableItem("Cogs", 1));
        nonConsumableItemsController.AddItem(new NonConsumableItem("Plastic Cog", 100));
    }
}
